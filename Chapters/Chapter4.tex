...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Chapters/Figures/Chapter 4 Figures/Si+Ag+PDMS (Final Result).png}
  \caption{Reflectance analysis for a composite of silicon, silver, and PDMS.}
  \label{fig:Reflectance analysis for silicon, silver, and PDMS}
\end{figure}
